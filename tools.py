...
* Date = '18/14/2024'                                              *
* Description = Streamlit App - Estaciones de Servicios - Funtiones*
********************************************************************
"""
...
# Locaciones contemplando el radio
...
#Creacion de los Pop-Up (marcadores)
...
#Define la llave de conexion a la API de Georeferenciacion
def Getkey():

    key_value = 'fajc-eeAAgghhODSDSWRP-opppdoo1233124_7888'

    return key_value

#Funcion de Conexion a la Base de Datos
def Conexion():
    server = 'DESKTOP-HOC7JT0'
